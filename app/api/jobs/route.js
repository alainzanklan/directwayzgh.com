...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: process.env.ZOHO_EMAIL, // your email
    pass: process.env.ZOHO_PASSWORD, // your email password or app password
  },
  tls: {
...
export const POST = async (request) => {
  try {
    ...
    const completeJobData = {
      ...
      owner: userId, // Use the actual userId from session
    };
    ...
    // Return success response with job ID for redirection
    return new Response(
      JSON.stringify({ 
        success: true,
