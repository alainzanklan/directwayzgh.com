...
import { FileText, Mail, Globe, Scale } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
              <div className="bg-orange-50 border-l-4 border-orange-400 p-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Without limiting the foregoing, neither the Company nor any of the company's provider makes any representation or warranty of any kind that the Service will be uninterrupted or error-free, or that any errors or defects can or will be corrected.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-700 text-sm">
                    The laws of Ghana, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service.
                  </p>
                </div>
                
                <div className="bg-green-50 p-4 rounded-lg">
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">Disputes Resolution</h3>
                  <p className="text-gray-700 text-sm">
              ...
              <div className="bg-gray-100 p-4 rounded-lg mb-4">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">For European Union (EU) Users</h3>
                <p className="text-gray-700 text-sm">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">Translation Interpretation</h3>
                  <p className="text-gray-700 leading-relaxed text-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <a href="https://directwayzgh.com" className="text-blue-600 hover:text-blue-700">
                      directwayzgh.com
                    </a>
                  </div>
                </div>
